...
export function FloatingButtons() {
    return (
        <>
            ...
            <Link href="tel:3854843525" className="fixed bottom-6 right-6 bg-accent text-white pl-5 pr-6 py-3.5 rounded-full font-bold shadow-2xl hover:scale-105 transition-transform z-50 flex items-center gap-3 animate-bounce-slow">
