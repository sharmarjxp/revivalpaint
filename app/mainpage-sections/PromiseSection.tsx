        ...
        <section className="py-24 relative bg-gray-900 text-white overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col items-start gap-10">
                <motion.div {...fadeInUp} className="max-w-2xl">
                    ...
                    <h3 className="text-4xl md:text-5xl font-bold mb-8 leading-tight text-white">The ALL AROUND SERVICE<br />Promise</h3>

                    <div className="grid sm:grid-cols-2 gap-6 mb-10">
                        {[
                            { title: 'Expert Craftsmanship', desc: 'Professional results on every project.' },
                            { title: 'Quality Materials', desc: 'Premium supplies for lasting solutions.' },
                            { title: 'On-Time Service', desc: 'We respect your schedule, always.' },
                            { title: 'Clean Work Site', desc: 'We leave your property spotless.' }
                        ].map((item, i) => (
